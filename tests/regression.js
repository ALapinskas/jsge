...
(async () => {
    ...
    const browser = await puppeteer.launch({/*executablePath: "C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe",*/ headless: false, args: ['--no-sandbox', '--disable-setuid-sandbox', '--disable-gpu']});
